		...
		<div class="col-md-6 col-md-offset-3">
			<div class="panel panel-warning">
			 	<div class="panel-heading">
			 		<h3 class="panel-title">Data Member : Edit Data</h3>
			 	</div>
			                 ...
			                 <div class="col-md-6">
			                    <div class="form-group">
			                        <?php 
			                            ...
			                            echo form_input('input_nama',set_value('input_nama',$db_data->nama,FALSE),'class="form-control" maxlength="60"');
			                ...
			                <div class="col-md-4">
			                    <div class="form-group">
			                        <?php 
			                            ...
			                            echo form_dropdown('input_jenis_kelamin',$arr_jenis_kelamin,set_value('input_jenis_kelamin',$db_data->jenis_kelamin,FALSE),'class="form-control" id="data_agama"');
			                 ...
			                 <div class="col-md-8">
			                    <div class="form-group">
			                        <?php 
			                            ...
			                            echo form_textarea('input_alamat',set_value('input_alamat',$db_data->alamat,FALSE),'class="form-control" style="height:100px" maxlength="60"');
			                 ...
			                 <div class="col-md-4">
			                    <div class="form-group">
			                        <?php 
			                            ...
			                            echo form_input('input_telepon',set_value('input_telepon',$db_data->telepon,FALSE),'class="form-control" maxlength="15"');
			                ...
			                <div class="col-md-4">
			                    <div class="form-group">
			                        <?php 
			                            ...
			                            echo form_dropdown('input_type',$arr_m_type,set_value('input_type',$db_data->type,FALSE),'class="form-control" id="data_agama"');
